osculating orbits is a powerful starting point for an approximate treatment of the orbital evolution. The relevant equations are displayed in Eqs. (3.69); we have
...
where $c : = \cos f , s : = \sin f , \mathcal { R } : = \pmb { n } \cdot \pmb { a } [ \operatorname { r r } ]$ is the radial component of the perturbing acceleration, and $\begin{array} { r } { S : = \lambda \cdot a [ \mathrm { r r } ] } \end{array}$ is the tangential component. These equations must be supplemented with
...
We now have all the required tools at our disposal, and we may return to the original problem, the determination of the orbital evolution under radiation reaction. The orbital elements are $\begin{array} { r } { \mu ^ { a } : = ( \mathsf { p } , e , \omega ) . } \end{array}$ , and the driving forces $F ^ { a }$ can be extracted from Eq. (12.227). Their averages are easily computed, and Eq. (12.235) returns
...
in which we have removed the now-redundant suffixes on p, $e$ , and t.
...
![](images/ad64bc4f1fb4fac9fc93016c7fc5cbbaa735587f65391b5b067e4bb35f1383f8.jpg)  
...
![](images/a5df4e6bab19e2fe9a8ae8bf69611fa0cc16bc11b56b83e0aabf865cb5a2009b.jpg)  
...
$$
\begin{array} { l } { { \displaystyle \mathbb { P } = \frac { 8 } { 1 5 } \eta ^ { 2 } \frac { c ^ { 3 } } { G } \bigg ( \frac { G m } { c ^ { 2 } r } \bigg ) ^ { 4 } \left( 1 2 v ^ { 2 } - 1 1 \dot { r } ^ { 2 } \right) , } } \\ { { \displaystyle \mathrm { \Sigma } ^ { \mathrm { \scriptsize \it ~ \displaystyle ~ \displaystyle ~ } } } } \\ { { \displaystyle \mathrm { \Sigma } ^ { \mathrm { \scriptsize \it ~ \displaystyle ~ \displaystyle ~ } } } } \\ { { \displaystyle \mathrm { \Sigma } ^ { j } = - \frac { 8 } { 1 0 5 } \Delta \eta ^ { 2 } \frac { c } { G } \bigg ( \frac { G m } { c ^ { 2 } r } \bigg ) ^ { 4 } \left[ v ^ { j } \bigg ( 5 0 v ^ { 2 } - 3 8 \dot { r } ^ { 2 } + 8 \frac { G m } { r } \bigg ) - \dot { r } n ^ { j } \bigg ( 5 5 v ^ { 2 } - 4 5 \dot { r } ^ { 2 } + 1 2 \frac { G m } { r } \bigg ) \right] , } } \\ { { \displaystyle \mathrm { \Sigma } ^ { j } = \frac { 8 } { 5 } \eta ^ { 2 } \frac { c } { G } \bigg ( \frac { G m } { c ^ { 2 } r } \bigg ) ^ { 3 } h ^ { j } \bigg ( 2 v ^ { 2 } - 3 \dot { r } ^ { 2 } + 2 \frac { G m } { r } \bigg ) . } } \end{array}
$$
...
On the ˙ω- $P$ plane, plot the curve corresponding to $T = 1$ billion years. Plot the curve from approximately 0.1 to 30 degrees per year for $\dot { \omega }$ , and from approximately 1 to
...
(b) In the limit where $e$ is close to unity, that is, when $e = 1 + \epsilon$ with $\epsilon \ll 1$ , show that the energy loss will convert the hyperbolic orbit into a bound orbit before pericenter when the following inequality is satisfied:
...
Third, a theory containing the metric $g _ { \alpha \beta }$ and additional dynamical or non-dynamical vector or tensor fields yields a local gravitational physics that may have both position and velocity-dependent effects. For example, a timelike vector field $K ^ { \alpha }$ , whose value is determined by the distribution of matter in the universe, will have only a time component $K ^ { 0 }$ in a reference frame in which the large-scale distribution of matter is isotropic, presumably the rest-frame of the cosmic background radiation. But in a quasi-local Lorentz frame that is moving relative to this frame with a velocity $\pmb { v }$ , the asymptotic form of $K ^ { \alpha }$ will have spatial components $K ^ { j } \propto K ^ { 0 } v ^ { j }$ , and these velocity-dependent components can then feed into the local form of the metric.
...
<table><tr><td>Box 13.1</td><td>Parameterized post-Newtonianmetric</td></tr><tr><td></td><td>Parameters:γ， β,ε,α1，α2，α3， 51， 52, 53, 54. Metric:</td></tr><tr><td></td><td>2 +(い-βU2）+F+(）, U+ 1 g00 = -1+</td></tr><tr><td></td><td>g0 =-−s[2(1+2)+2α1]U,-23[1+aα2-51 +25]a,jxX</td></tr><tr><td></td><td>+</td></tr><tr><td></td><td>gjk=(1+U）δjx+c)；</td></tr></table>
...
$$
\begin{array} { r l } & { \quad \quad \times ( - \frac { 1 } { N } ) ^ { 2 } , } \\ & { \quad \times \quad \times ( - \frac { 1 } { N } ) ^ { 2 } \left( \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x } \right) ^ { 2 } } \\ & { \quad \times ( - \frac { 1 } { N } ) ^ { 2 } \left( \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x } \right) ^ { 2 } } \\ & { \quad \times \quad \times - \phi \left( \frac { 1 } { N } - \frac { 1 } { N } \epsilon ^ { 2 } \eta \right) ^ { 2 } } \\ & { \quad \quad + \frac { 1 } { N } \epsilon ^ { 2 } \epsilon ^ { 2 } } \\ & { \quad \quad \times \quad - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } ^ { 2 } } { \partial x ^ { 2 } } } \\ & { \quad \quad \times \quad \times - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } } \\ & { \quad \quad \times \quad \times - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } } \\ & { \quad \quad \times \quad \times - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } } \\ & { \quad \quad \times \quad \times \quad - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } } \\ &  \quad \quad \times \quad \times \quad - \epsilon \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \int _ { - \frac { 1 } { N } } ^ { \frac { 1 } { N } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } \frac { \partial \hat { \phi } _ { \epsilon } } { \partial x ^ { 2 } } \\ &  \quad \times \quad \times \quad \times \quad \times \quad \times \quad \times \quad \times \quad \times \quad \end{array}
$$
...
<table><tr><td colspan="4">Table 13.1 PPN parameters and their physical significance. Note that α3 is listed twice to indicate that it isameasureof twoseparate effects.</td></tr><tr><td>Parameter</td><td>What it measures relative to GR</td><td>Semi-conservative GR value theories</td><td>Fully-conservative theories</td></tr><tr><td>Y</td><td>How much spatial curvature produced by unit rest mass?</td><td>1 Y</td><td>Y</td></tr><tr><td>β</td><td>How much &quot;nonlinearity” in the superposition of gravity?</td><td>1 β</td><td>β</td></tr><tr><td>m</td><td>Preferred-location effects?</td><td>0 m</td><td>m</td></tr><tr><td>α1 α2</td><td>Preferred-frame effects?</td><td>0 α1 0 α2</td><td>0 0</td></tr><tr><td>α3 α3</td><td>0</td><td>0</td><td>0</td></tr><tr><td>51</td><td> Is total</td><td>0 0</td><td>0</td></tr><tr><td>52</td><td>momentum 0 0</td><td>0</td><td>0</td></tr><tr><td>53</td><td>conserved?</td><td>0 0</td><td>0</td></tr><tr><td>54</td><td>0 0</td><td>0</td><td>0 0</td></tr><tr><td></td><td></td><td></td><td></td></tr></table>

The choice of parameters is made (with considerable hindsight, to be sure) to ensure that their values are particularly simple in general relativity, but more importantly, to ensure also that specific physical meanings can be attached to them. These heuristic meanings are summarized in Table 13.1. The parameters $\beta$ and $\gamma$ are directly related to Eddington’s original parameters. Roughly speaking, $\beta$ measures how non-linear gravity is, in that it multiplies the $U ^ { 2 }$ term in $g _ { 0 0 }$ , and $\gamma$ measures the spatial curvature generated by a body relative to what general relativity would predict; specifically, a calculation of the Riemann curvature tensor for the three-dimensional subspace defined by $d t = 0$ gives a result proportional to $\gamma G M / ( c ^ { 2 } r ^ { 3 } )$ . These meanings are not to be taken literally, because they are very much tied to the choice of coordinates. In general relativity, for example, the Schwarzschild metric expressed in the standard Schwarzschild coordinates has no term quadratic in $G M / ( c ^ { 2 } r )$ in $g _ { 0 0 }$ ; the post-Newtonian limit of the metric takes the Eddington form of Eq. (13.1) with $\beta = \gamma = 1$ only in isotropic coordinates. The lesson is that the interpretation of the PPN parameters must be viewed as a rough heuristic.
...
$$
\begin{array} { r l } { \rho ^ { \star } \frac { d v ^ { \prime } } { d t } = - \lambda _ { j } p + \rho ^ { \star } \partial _ { j } U } \\ & { + \frac { 1 } { c ^ { 2 } } \Bigg \lbrace \Bigg [ \frac { 1 } { 2 } v ^ { 2 } + ( 2 - \gamma ) U + \Pi + \frac { p } { \rho ^ { \star } } \Bigg ] \partial _ { j } p - v ^ { \prime } \partial _ { j } p \Bigg \rbrace } \\ & { + \frac { 1 } { c ^ { 2 } } \rho ^ { \star } \Bigg \lbrace \Bigg \lbrace \gamma v ^ { 2 } - 2 ( \gamma + \beta ) U \Bigg \rbrace \partial _ { j } U } \\ & { - v ^ { \prime } \Bigg [ ( 2 \gamma + 1 ) \partial _ { j } U + 2 ( \gamma + 1 ) v ^ { \star } \partial _ { k } U \Bigg ] } \\ & { + \frac { 1 } { 2 } ( 4 \gamma + 4 + \alpha _ { 1 } ) \Big [ \partial _ { j } U _ { j } + v ^ { \star } ( \partial _ { j } U _ { j } - \partial _ { j } U _ { k } ) \Big ] + \partial _ { j } \psi \Bigg \rbrace } \\ & { + \frac { 1 } { c ^ { 2 } } \rho ^ { \star } \Bigg [ \frac { 1 } { 2 } \partial _ { j } \phi ^ { w _ { m } } - \partial _ { i } \Phi _ { j } ^ { w _ { m } } - v ^ { w } ( \partial _ { k } \Phi _ { j } ^ { w } - \partial _ { j } \Phi _ { k } ^ { w } ) \Bigg ] } \\ & { + O ( c ^ { - 4 } ) , } \end{array}
$$
...
$$
\begin{array} { r l } { m _ { A } c ^ { 2 } ( a _ { A } ^ { j } ) _ { \mathrm { s e f f } } = \Big [ 2 L _ { A } ^ { ( j k ) } - ( 2 + \alpha _ { 2 } ) H _ { A } ^ { j k } - ( 2 + \alpha _ { 2 } + \alpha _ { 3 } ) H _ { A } ^ { k j } + 3 ( 1 + \alpha _ { 2 } ) K _ { A } ^ { j k } } & { } \\ { + ( \alpha _ { 1 } - \alpha _ { 2 } ) \delta ^ { j k } H _ { A } - \delta ^ { j k } \bar { P } _ { A } \Big ] v _ { A } ^ { k } } & { } \\ { + \Big [ \alpha _ { 1 } H _ { A } \delta ^ { j k } - \alpha _ { 2 } ( 2 H _ { A } ^ { ( j k ) } - 3 K _ { A } ^ { j k } + H _ { A } \delta ^ { j k } ) - \alpha _ { 3 } H _ { A } ^ { k j } \Big ] w ^ { k } } & { } \\ { + \Big [ 2 \gamma T _ { A } + ( 4 \beta - 3 - \alpha _ { 1 } + \alpha _ { 2 } - \zeta _ { 1 } - 4 \xi ) \Omega _ { A } + 3 \gamma P _ { A } \Big ] \partial _ { j } U _ { - d } } & { } \\ { - \Big [ 4 ( \gamma + 1 ) T _ { A } ^ { j k } + ( 2 \gamma + 2 + \alpha _ { 2 } - \zeta _ { 1 } + \zeta _ { 2 } ) \Omega _ { A } ^ { j k } } & { } \\ { + 2 ( \gamma + 1 ) \delta ^ { j k } P _ { A } \Big ] \partial _ { k } U _ { - A } + \xi \Omega _ { A } ^ { k l } \partial _ { j k l } X _ { - A } . } & { \qquad ( 1 } \end{array}
$$
...
where $\pmb { a } _ { \mathcal { A } } [ 0 \mathrm { \bf p N } ]$ is the Newtonian acceleration, $\pmb { a } _ { \ r { A } } [ 1 \mathrm { P N } ]$ groups all the post-Newtonian corrections that do not depend on the internal structures of the bodies, and $\pmb { a } _ { A } [ \mathrm { \bf S T R } ]$ contains all the structure-dependent terms. As we also did back in Sec. 9.3.5, we pull out a term

$$
{ \bf { a } } _ { A } [ \mathrm { { s T R } } ] ^ { \prime } = - \sum _ { B \ne A } { \frac { G ( E _ { B } / c ^ { 2 } ) } { r _ { A B } ^ { 2 } } } { \bf { n } } _ { A B } ,
$$

from $\pmb { a } _ { A } [ \mathbf { S } \mathbf { T } \mathbf { R } ]$ , where $E _ { B } = \mathcal { T } _ { B } + \Omega _ { B } + E _ { B } ^ { \mathrm { i n t } }$ is the total internal energy of body $B$ , and combine it with the 0pn term to obtain

$$
{ \pmb a } _ { \cal A } [ 0 \mathrm { P N } ] + { \pmb a } _ { \cal A } [ \mathrm { S T R } ] ^ { \prime } = - \sum _ { B \not = A } { \frac { G M _ { B } } { r _ { A B } ^ { 2 } } } { \pmb n } _ { A B } ,
$$

where $M _ { B } : = m _ { B } + E _ { B } / c ^ { 2 } + { \cal O } ( c ^ { - 4 } )$ is the total gravitational mass of body $B$ . We can then insert $m _ { B } = M _ { B } + O ( c ^ { - 2 } )$ in all post-Newtonian terms in the acceleration without changing the equations of motion at 1pn order. In Chapter 9 this procedure eliminated all structure-dependent terms from the equations of motion. Here, in contrast, the remaining terms are given by

$$
\begin{array} { l } { { { \displaystyle z ^ { 2 } a _ { i } ^ { j } [ 5 \pi ] = - \frac { \alpha _ { 3 } ^ { \prime } } { M _ { d } } { } ^ { i j } ( w _ { k } + v _ { i A } ) } } } \\ { { \ \ \qquad + \ \sum _ { \vartheta \neq 4 } ^ { \infty } G M _ { s } \Bigg \{ ( 4 \beta - \gamma - 3 - 4 \xi - \alpha _ { 1 } + \alpha _ { 2 } - \zeta _ { 1 } ) \frac { \Omega _ { d } } { M _ { d } } { } _ { ( r , s ) } ^ { - 1 } } } \\ { { \ \qquad - \left( \alpha _ { 2 } - \zeta _ { 1 } + \zeta _ { 2 } \right) \frac { \Omega _ { d } ^ { \cal A } } { M _ { d } } { } _ { ( r , s ) } ^ { - 1 } + \frac { \zeta - \alpha _ { 1 } ^ { \prime } } { M _ { d } } { } _ { ( r , s ) } ^ { i j } r ^ { i } \ A ^ { \prime } } } \\ { { \ \ \qquad + \left( 4 \beta - \gamma - 3 - 4 \xi - \frac { 1 } { 2 } \alpha _ { 3 } - 2 \zeta \right) \frac { \Omega _ { B } } { M _ { d } } { } _ { \vartheta j } ^ { i j } ( r _ { i \omega } ) ^ { - 1 } } } \\ { { \ \ \qquad + \left( \xi - \frac { 1 } { 2 } \zeta _ { 1 } \right) \frac { \Omega _ { d } ^ { \cal A } } { M _ { d } } { } _ { \partial i j r i \alpha } - \zeta _ { 1 } \frac { E _ { \mathrm { d } } ^ { i m } } { M _ { d } } { } _ { j } ( r _ { i \omega } ) ^ { - 1 } } } \\ { { \ \qquad + \left( \frac { 3 } { 2 } \alpha _ { 3 } - 3 \zeta _ { 4 } + \zeta _ { 1 } \right) \frac { P _ { R _ { 0 } } } { M _ { d } } { } _ { ( r , s ) } ^ { j - 1 } \Bigg \} . } } \end{array}
$$

These structure-dependent terms all vanish when the PPN parameters take their general relativistic values. In general, however, the acceleration of a body in the field of other bodies can depend on its internal structure (dependence on $\Omega _ { A }$ ), and can even contain a component in a direction perpendicular to the direction of the other body (dependence on $\Omega _ { A } ^ { j k \cdot }$ ). Furthermore, the gravitational attraction produced by an external body can depend on its own internal structure (dependence on $\Omega _ { B }$ $B , E _ { B } ^ { \mathrm { i n t } } , P _ { B } )$ . These violations of the strong equivalence principle can persist even in a fully conservative theory $\textstyle ( \alpha _ { n } = \zeta _ { n } = 0$ ), depending on the values of $\gamma$ , $\beta$ , and $\xi$ . We notice the remarkable fact that the term proportional to $\alpha _ { 3 }$ depends on the body’s net velocity ${ \pmb w } + { \pmb v } _ { A }$ relative to the preferred frame; as we have observed before, general covariance implies that the equations of motion cannot depend on the velocity of the PPN frame relative to the preferred frame.
...
$$
\begin{array} { l } { { \displaystyle { \pmb a } _ { \cal A } [ \mathrm { E X T } ] = - \sum _ { B \not = { \cal A } } \frac { G M _ { B } } { r _ { A B } ^ { 2 } } { \pmb n } _ { A B } } } \\ { { \displaystyle ~ + \frac { 1 } { c ^ { 2 } } \left[ - \sum _ { B \not = { \cal A } } \frac { G M _ { B } } { r _ { A B } ^ { 2 } } \biggl \{ \gamma v _ { A } ^ { 2 } - ( 2 \gamma + 2 ) ( { \pmb v } _ { { \cal A } } \cdot { \pmb v } _ { B } ) + ( \gamma + 1 ) v _ { B } ^ { 2 } \biggr . \right. } } \end{array}
$$

(continued overleaf)

$$
\begin{array} { r l } & { - \frac { 2 } { 3 } \mathbf { R e } \lambda \boldsymbol { \phi } } \\ & { = - \frac { 1 } { 2 } \mathbf { R e } \lambda \boldsymbol { \phi } - \boldsymbol { \phi } \mathbf { \phi } \boldsymbol { \phi } ^ { 2 } \frac { 1 } { 2 } \{ \mathbf { I } \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) + \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) \boldsymbol { \phi } ( \mathbf { \phi } ^ { 2 } ) \boldsymbol { \phi } ( \mathbf { \phi } ^ { 2 } )  } \\ &   - \frac { 1 } { 2 } \mathbf { R e } \{ 0 - \mathbf { R e } \{ 0 - \mathbf { \phi } \} \} - \lambda \boldsymbol { \phi } \{ \mathbf { I } \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) - \boldsymbol { \phi } ^ { 2 } \} \lambda \mathbf { R e } \{ ( - \mathbf { \phi } ^ { 2 } ) \{ \boldsymbol { \phi } ^ { 2 } ( \mathbf { R e } \mathcal { I } \mathcal { R } ) \} \} \lambda _ { \mathrm { { o r e } } } \\ & {  [ \Phi ^ { 2 } ] \{ \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) \{ 1 \} \} \lambda _ { \mathrm { o r e } } ^ { 2 } \lambda _ { \mathrm { o } } ^ { 2 } \{ \frac { 1 } { 2 } \lambda _ { \mathrm { o } } ^ { 2 } \{ \mathbf { I } \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) \} \{ \lambda _ { \mathrm { o r e } } \{ 0 \} ^ { 2 } \lambda _ { \mathrm { o } } ^ { 2 } \{ \frac { 1 } { 2 } \lambda _ { \mathrm { o } } ^ { 2 } \{ \mathbf { I } \boldsymbol { \phi } \} \} ] \mathrm { a s s } } \\ &  [ \Phi ^ { 2 } ] \{ \mathbf { I } \boldsymbol { \phi } ^ { 2 } ( \mathbf { \phi } ^ { 2 } ) \{ 1 \} \{ \lambda _ { \mathrm { o r e } } \{ [ \partial _ { \mathbf { r e } } \lambda _ { \mathrm { o } } ] - \lambda _ { \mathrm { o } } ^ { 2 } \{ \alpha _ { 0 } ^ { 2 } [ \Phi ^ { 2 } ] \{ \mathbf { I } \boldsymbol { \phi } ^ { 2 } \} \lambda _ { \mathrm { o r e } } \{ \mathbf { I } \boldsymbol  \phi  \end{array}
$$
...
$$
{ \bf F } _ { \cal A } = ( M _ { \cal T } ) _ { \cal A } \frac { d { \pmb v } _ { \cal A } } { d t } = ( M _ { \cal P } ) _ { \cal A } \nabla \sum _ { B \neq \cal A } \frac { ( M _ { \cal A } ) _ { B } } { r _ { \cal A B } } ,
$$
...
$$
\begin{array} { l } { { \displaystyle { G _ { \mathrm { e f f } } : = G \bigg \{ 1 - \frac { 1 } { c ^ { 2 } } ( 4 \beta - \gamma - 3 - 4 \xi - \zeta _ { 2 } ) \hat { U } _ { \mathrm { e x t } } - \frac { 1 } { c ^ { 2 } } \xi \bar { n } ^ { j } \bar { n } ^ { k } \partial _ { \bar { j } \bar { k } } \hat { X } _ { \mathrm { e x t } } } } } \\ { { \displaystyle { \qquad - \frac { 1 } { 2 c ^ { 2 } } ( \alpha _ { 1 } - \alpha _ { 2 } - \alpha _ { 3 } ) ( w + v ) ^ { 2 } - \frac { 1 } { 2 c ^ { 2 } } \alpha _ { 2 } \big [ ( w + v ) \cdot \bar { n } \big ] ^ { 2 } } } } \\ { { \displaystyle { \qquad - \frac { 1 } { 2 c ^ { 2 } } ( 4 \beta - \gamma - 3 - 4 \xi + \alpha _ { 2 } - \zeta _ { 1 } ) \bar { x } ^ { k } \partial _ { \bar { k } } \hat { U } _ { \mathrm { e x t } } } } } \\ { { \displaystyle { \qquad - \frac { 1 } { 2 c ^ { 2 } } \xi \bar { r } \bar { n } ^ { j } \bar { n } ^ { k } \bar { n } ^ { l } \partial _ { \bar { j } \bar { k } \bar { l } } \hat { X } _ { \mathrm { e x t } } \bigg \} , } } } \end{array}
$$
...
$$
\begin{array} { r l r } {  { ( \frac { d S _ { \cal A } ^ { j } } { d t } ) _ { \mathrm { s e l f } } = - \epsilon ^ { j p q } \frac { 1 } { c ^ { 2 } } \frac { d } { d t } \int _ { \cal A } \rho ^ { \ s } \bar { x } ^ { p } \biggl [ \bar { v } ^ { q } ( \frac { 1 } { 2 } \bar { v } ^ { 2 } + ( 2 \gamma + 1 ) U _ { \cal A } + \Pi + \frac { p } { \rho ^ { \ s } } ) } } \\ & { } & { \qquad - \frac { 1 } { 2 } ( 4 \gamma + 4 + \alpha _ { 1 } ) U _ { \cal A } ^ { q } - \frac { 1 } { 2 } ( 1 + \alpha _ { 2 } ) \partial _ { t q } X _ { \cal A } \biggr ] d ^ { 3 } \bar { x } } \\ & { } & { \quad + \epsilon ^ { j p q } \frac { 1 } { c ^ { 2 } } \int _ { \cal A } \rho ^ { \ s } \bar { x } ^ { p } \biggl [ \frac { 1 } { 2 } \alpha _ { 3 } \partial _ { q } \Phi _ { 1 \cal A } + \zeta _ { 2 } \partial _ { q } \Phi _ { 2 \cal A } + \zeta _ { 3 } \partial _ { q } \Phi _ { 3 \cal A } } \\ & { } & { \qquad + ( 3 \zeta _ { 4 } - \zeta _ { 1 } ) \partial _ { q } \Phi _ { 4 \cal A } + \frac { 1 } { 2 } \zeta _ { 1 } \partial _ { q } \Phi _ { 5 \cal A } \biggr ] d ^ { 3 } \bar { x } . \quad \quad ( 1 3 . } \end{array}
$$
...
$$
\left( \frac { d S _ { A } ^ { j } } { d t } \right) _ { \Omega _ { \cal A } } = \epsilon ^ { j p q } \frac { 1 } { c ^ { 2 } } \Omega _ { \cal A } ^ { p n } \biggl [ \alpha _ { 2 } ( w + v _ { \cal A } ) ^ { q } ( w + v _ { \cal A } ) ^ { n } - 2 \xi \sum _ { B \not = A } \frac { m _ { B } } { r _ { A B } } n _ { A B } ^ { q n } \biggr ] .
$$
...
$$
\bar { \bar { S } } _ { \mathscr { A } } : = \bar { S } _ { \mathscr { A } } + \Delta _ { \mathrm { e x t } } \bar { S } _ { \mathscr { A } } = \bar { S } _ { \mathscr { A } } + \frac { 1 } { c ^ { 2 } } \Bigg \{ \big [ v _ { \mathscr { A } } ^ { 2 } + ( 2 \gamma + 1 ) U _ { \neg \mathscr { A } } \big ] \bar { S } _ { \mathscr { A } } - \frac { 1 } { 2 } ( v _ { \mathscr { A } } \cdot \bar { S } _ { \mathscr { A } } ) v _ { \mathscr { A } } \Bigg \} ,
$$
...
$$
\Omega _ { \scriptscriptstyle A } = \Omega _ { \scriptscriptstyle A } [ \mathrm { s o } ] + \Omega _ { \scriptscriptstyle A } [ \mathrm { s s } ] + \Omega _ { \scriptscriptstyle A } [ \mathrm { P F } ] ,
$$

$$
\pmb { \Omega } _ { \cal A } [ \mathrm { s o } ] = \frac { 1 } { 2 c ^ { 2 } } \sum _ { B \neq { \cal A } } \frac { G M _ { B } } { r _ { A B } ^ { 2 } } { \pmb n } _ { A B } \times \left[ ( 2 \gamma + 1 ) { \pmb v } _ { A } - ( 2 \gamma + 2 ) { \pmb v } _ { B } \right] ,
$$

$$
\pmb { \Omega } _ { \scriptscriptstyle A } [ \mathrm { s s } ] = \frac { 4 \gamma + 4 + \alpha _ { 1 } } { 8 c ^ { 2 } } \sum _ { B \not = A } \frac { G } { r _ { \scriptscriptstyle A B } ^ { 3 } } \big [ 3 { \pmb n } _ { \scriptscriptstyle A B } ( { \pmb n } _ { \scriptscriptstyle A B } \cdot \bar { \pmb S } _ { B } ) - \bar { \pmb S } _ { B } \big ] ,
$$

$$
\Omega _ { \scriptscriptstyle A } [ \mathrm { p F } ] = - \frac { \alpha _ { 1 } } { 4 c ^ { 2 } } \sum _ { B \not = A } \frac { G M _ { B } } { r _ { \scriptscriptstyle A B } ^ { 2 } } { \pmb n } _ { \scriptscriptstyle A B } \times ( { \pmb w } + { \pmb v } _ { B } ) .
$$
...
$$
\begin{array} { c } { { + \displaystyle \frac { 1 } { 2 } ( 2 \gamma + 2 + \alpha _ { 2 } + \alpha _ { 3 } ) v _ { 2 } ^ { 2 } - \frac { 3 } { 2 } ( 1 + \alpha _ { 2 } ) ( n \cdot v _ { 2 } ) ^ { 2 } } } \\ { { - \left( 2 \gamma + 2 \beta + 1 + \displaystyle \frac { 1 } { 2 } \alpha _ { 1 } - \zeta _ { 2 } \right) \displaystyle \frac { G M _ { 1 } } { r } - ( 2 \gamma + 2 \beta ) \displaystyle \frac { G M _ { 2 } } { r } \Bigg ] n } } \\ { { + \displaystyle \frac { G M _ { 2 } } { r ^ { 2 } } \Big \{ n \cdot \big [ ( 2 \gamma + 2 ) v _ { 1 } - ( 2 \gamma + 1 ) v _ { 2 } \big ] \Big \} v _ { 1 } } } \\ { { - \displaystyle \frac { 1 } { 2 } \displaystyle \frac { G M _ { 2 } } { r ^ { 2 } } \Big \{ n \cdot \big [ ( 4 \gamma + 4 + \alpha _ { 1 } ) v _ { 1 } - ( 4 \gamma + 2 + \alpha _ { 1 } - 2 \alpha _ { 2 } ) v _ { 2 } \big ] \Big \} v _ { 2 } \Bigg ] } } \\ { { . . . } } \end{array}
$$

where $r : = r _ { 1 } - r _ { 2 } , \ r : = | r | , \ n : = r / r$ , and $M _ { \mathcal { P } }$ , $M _ { A }$ for each body are given by Eqs. (13.30). The equations of motion for the second body are obtained by interchanging the variables according to $M _ { 1 }  M _ { 2 }$ , ${ \pmb v } _ { 1 }  { \pmb v } _ { 2 }$ , and $n  - n$ .
...
$$
\begin{array} { c } { { \displaystyle a = - \frac { G m ^ { * } } { r ^ { 2 } } n - \frac { G m } { r ^ { 2 } c ^ { 2 } } \bigg \{ \bigg [ \Big ( \gamma + \frac { 1 } { 2 } \eta [ 6 + \alpha _ { 1 } + \alpha _ { 2 } + \alpha _ { 3 } ] \Big ) v ^ { 2 } } } \\ { { - \frac { 3 } { 2 } \eta ( 1 + \alpha _ { 2 } ) ( n \cdot v ) ^ { 2 } - \big ( 2 \gamma + 2 \beta + \eta [ 2 + \alpha _ { 1 } - 2 \zeta _ { 2 } ] \big ) \frac { G m } { r } \bigg ] n } } \\ { { - \big ( 2 \gamma + 2 - \eta [ 2 - \alpha _ { 1 } - \alpha _ { 2 } ] \big ) ( n \cdot v ) v \bigg \} + { \cal O } ( c ^ { - 4 } ) , \qquad ( 1 3 . 4 3 \times \alpha ^ { - 1 } ) , \qquad ( 2 \zeta ) . } } \end{array}
$$

where $\eta : = { M _ { 1 } M _ { 2 } } / { m ^ { 2 } }$ and

$$
\begin{array} { r l } & { m ^ { * } : = \left( \cfrac { M _ { \mathcal { P } } } { M } \right) _ { 1 } ( M _ { \mathcal { A } } ) _ { 2 } + \left( \cfrac { M _ { \mathcal { P } } } { M } \right) _ { 2 } ( M _ { \mathcal { A } } ) _ { 1 } } \\ & { \quad = m + O ( c ^ { - 2 } ) \times \left[ \mathrm { s t r u c t u r e - d e p e n d e n t t e r m s } \right] . } \end{array}
$$
...
where $\pmb { r } _ { c 3 } : = \pmb { r } _ { c } - \pmb { r } _ { 3 }$ and $\pmb { r } _ { 1 c } : = \pmb { r } _ { 1 } - \pmb { r } _ { c }$ ; we develop a similar expansion for $r _ { 2 3 } ^ { j } / r _ { 2 3 } ^ { 3 }$ . We define $R : = r _ { c 3 } = | r _ { c 3 } |$ $\begin{array} { r } { \dot { \mathbf { \eta } } _ { c 3 } = | r _ { c 3 } | , N : = r _ { c 3 } / r _ { c 3 } , r _ { 1 c } : = | r _ { 1 c } | , \pmb { n } _ { 1 c } : = r _ { 1 c } / r _ { 1 c } , r _ { 2 c } : = | r _ { 2 c } | , \pmb { n } _ { 2 c } : = } \end{array}$ $r _ { 2 c } / r _ { 2 c }$ , and note that
...
$$
\begin{array} { r l } & { \displaystyle \frac { d a } { d t } = \frac { 2 } { \omega _ { \oplus } } S + O ( e ) , } \\ & { \displaystyle \frac { d A } { d t } = \frac { 1 } { \omega _ { \oplus } a } \Big [ \mathcal { R } \sin ( \omega _ { \oplus } t ) + 2 S \cos ( \omega _ { \oplus } t ) \Big ] + O ( e ) , } \\ & { \displaystyle \frac { d B } { d t } = \frac { 1 } { \omega _ { \oplus } a } \Big [ - \mathcal { R } \cos ( \omega _ { \oplus } t ) + 2 S \sin ( \omega _ { \oplus } t ) \Big ] + O ( e ) , } \end{array}
$$
...
$$
\begin{array} { r l r } {  { \mathcal { R } = \omega _ { \odot } ^ { 2 } a \Bigg \{ \big [ 3 \cos ^ { 2 } ( \Lambda t + \Phi ) - 1 \big ] - \frac { 3 } { 2 } \zeta \cos ( \Lambda t + \Phi ) \big [ 5 \cos ^ { 2 } ( \Lambda t + \Phi ) - 3 \big ] } } \\ & { } & \\ & { } & { \qquad - \delta ( R / a ) \cos ( \Lambda t + \Phi ) \Bigg \} , } \\ & { } & { \quad \mathcal { S } = \omega _ { \odot } ^ { 2 } a \Bigg \{ - 3 \sin ( \Lambda t + \Phi ) \cos ( \Lambda t + \Phi ) + \frac { 3 } { 2 } \zeta \sin ( \Lambda t + \Phi ) \big [ 5 \cos ^ { 2 } ( \Lambda t + \Phi ) - 1 \big ] } \\ & { } & \\ & { } & { \qquad + \delta ( R / a ) \sin ( \Lambda t + \Phi ) \Bigg \} , ~ ( 1 3 . 7 ) } \end{array}
$$
...
We choose a reference frame in which the center-of-mass of the system is at rest, and we first examine the metric of a stationary system in this frame. Inspecting $8 0 \mathbf { x } \ 1 3 . 1$ , we see that the leading contribution to the 1pn metric when $R \to \infty$ is given by
...
We see that there is a $c ^ { - 2 }$ contribution to $h ^ { j k }$ whenever $\gamma \neq 1$ ; in general relativity this term vanishes, and indeed, when $\gamma = 1$ and $\alpha _ { 1 } = \alpha _ { 2 } = 0$ we recover the stationary limit of the expressions listed, for example in Eq. (11.6).
...
in which $A _ { \mathrm { T } } ^ { j }$ and $D _ { \mathrm { T } } ^ { j }$ are transverse vector fields satisfying $N _ { j } A _ { \mathrm { T } } ^ { j } = N _ { j } D _ { \mathrm { T } } ^ { j } = 0$ , and $A _ { \mathrm { T T } } ^ { j k }$ is a transverse-tracefree tensor field satisfying $N _ { j } A _ { \mathrm { T T } } ^ { j k } = \delta _ { j k } \bar { A _ { \mathrm { T T } } ^ { j k } } \dot { = } 0$ . The decomposition involves ten independent functions of $\tau$ and $N$ .

The freedom to transform the coordinates must be restricted by the requirement that in the far-away wave-zone, $h ^ { \alpha \beta }$ must always be of the general form described by Eqs. (13.78) and (13.79). This implies that the allowed transformations are small deformations described by $x ^ { \alpha }  x ^ { \prime \alpha } = x ^ { \alpha } + \zeta ^ { \alpha } ( x ^ { \beta } )$ , with a gauge vector $\zeta ^ { \alpha }$ restricted to be of the general form
...
first introduced in Sec. 11.1.5. Note that the gauge vector field satisfies the wave equation $\begin{array} { r } { \boxed { 1 } \zeta ^ { \alpha } = O ( R ^ { - 2 } ) } \end{array}$ . This does not occur because of a requirement to keep $x ^ { \prime \alpha }$ within the class of harmonic coordinates, as was the case back in Sec. 11.1.5. Instead, this is an automatic property of the assumed form for $\zeta ^ { \alpha }$ , which is designed to preserve the form of the gravitational potentials.
...
$$
\begin{array} { l } { { C ^ { \prime } = C + \partial _ { \tau } ( \alpha + \beta ) , } } \\ { { \ } } \\ { { D ^ { \prime } = D + \partial _ { \tau } ( \alpha + \beta ) , } } \\ { { \ } } \\ { { D _ { \mathrm { T } } ^ { \prime \prime } = D _ { \mathrm { T } } ^ { \prime } + \partial _ { \tau } \beta _ { \mathrm { T } } ^ { j } , } } \\ { { \ } } \\ { { \ A ^ { \prime } = A + \partial _ { \tau } ( 3 \alpha - \beta ) , } } \\ { { \ } } \\ { { \beta ^ { \prime } = B + 2 \partial _ { \tau } \beta , } } \\ { { \ } } \\ { { { A _ { \mathrm { T } } ^ { \prime \prime } = A _ { \mathrm { T } } ^ { \prime } + \partial _ { \tau } \beta _ { \mathrm { T } } ^ { j } , } } } \\ { { \ } } \\ { { { A _ { \mathrm { T } } ^ { \prime \prime \prime } = A _ { \mathrm { T } } ^ { \prime \prime \prime } . } } } \end{array}
$$
...
To describe the gravitational-wave modes in more concrete terms, we make use of the vector basis $( N , \vartheta , \varphi )$ first introduced in Sec. 11.1.7. Employing the polar angles $( \vartheta , \varphi )$ t o describe the direction of propagation, we write
...
and we insert the expressions for $e _ { 1 }$ and $\boldsymbol { e } _ { 2 }$ displayed in Eq. (11.319). After some manipulations we obtain

$$
S ( t ) = F _ { \mathrm { { S } } } A _ { \mathrm { { S } } } + F _ { \mathrm { { L } } } A _ { \mathrm { { L } } } + F _ { \mathrm { { V } 1 } } A _ { \mathrm { { V } 1 } } + F _ { \mathrm { { V } 2 } } A _ { \mathrm { { V } 2 } } + F _ { + } S _ { + } + F _ { \times } S _ { \times } ,
$$
...
$$
g _ { \alpha \beta } : = ( \phi _ { 0 } / \phi ) \tilde { g } _ { \alpha \beta } ,
$$
...
$$
{ \tilde { G } } _ { \alpha \beta } - \frac { 1 } { 2 } { \tilde { \Theta } } ^ { \alpha \beta } = \frac { 8 \pi { \tilde { G } } } { c ^ { 4 } } { \tilde { T } } _ { \alpha \beta } ,
$$

in which $\tilde { G } _ { \alpha \beta }$ is the Einstein tensor associated with the auxiliary metric,

$$
\tilde { \Theta } ^ { \alpha \beta } : = \frac { 2 \omega + 3 } { \phi ^ { 2 } } \biggl ( \partial _ { \alpha } \phi \partial _ { \beta } \phi - \frac { 1 } { 2 } \tilde { g } _ { \alpha \beta } \tilde { g } ^ { \mu \nu } \partial _ { \mu } \phi \phi _ { \nu } \phi \biggr ) - V ( \phi ) \tilde { g } _ { \alpha \beta } ,
$$
...
$$
\tilde { t } _ { \phi } ^ { \alpha \beta } : = \frac { c ^ { 4 } } { 1 6 \pi \tilde { G } } ( - \tilde { g } ) \tilde { \Theta } ^ { \alpha \beta } .
$$
...
$$
\tilde { g } ^ { \alpha \beta } \tilde { \nabla } _ { \alpha } \tilde { \nabla } _ { \beta } \phi = \frac { 1 } { \sqrt { - \tilde { g } } } \partial _ { \alpha } \bigl ( \tilde { \mathfrak { g } } ^ { \alpha \beta } \partial _ { \beta } \phi \bigr ) = \frac { 1 } { \sqrt { - \tilde { g } } } \bigl ( \sqcap \phi - \tilde { h } ^ { \alpha \beta } \partial _ { \alpha \beta } \phi \bigr ) ,
$$
...
$$
\begin{array} { r l } & { c ^ { - 2 } ( - \tilde { g } ) t _ { \mathrm { L L } } ^ { 0 0 } = - \displaystyle \frac { 7 } { 8 \pi \tilde { G } c ^ { 2 } } \partial _ { n } \tilde { V } \partial _ { n } \tilde { V } + O ( c ^ { - 4 } ) , } \\ & { c ^ { - 1 } ( - \tilde { g } ) t _ { \mathrm { L L } } ^ { 0 j } = O ( c ^ { - 2 } ) , } \\ & { \quad ( - \tilde { g } ) t _ { \mathrm { L L } } ^ { j k } = \displaystyle \frac { 1 } { 4 \pi \tilde { G } } \biggl ( \partial _ { j } \tilde { V } \partial _ { k } \tilde { V } - \displaystyle \frac { 1 } { 2 } \delta _ { j k } \partial _ { n } \tilde { V } \partial _ { n } \tilde { V } \biggr ) + O ( c ^ { - 2 } ) . } \end{array}
$$
...
$$
\begin{array} { r l } & { c ^ { - 2 } \tilde { \tau } ^ { 0 0 } = \rho ^ { * } \bigg [ 1 + \frac { 1 } { c ^ { 2 } } \bigg ( \frac { 1 } { 2 } v ^ { 2 } + 3 \tilde { V } + \Pi - f \bigg ) \bigg ] } \\ & { \qquad + \frac { 1 } { 4 \pi \tilde { G } c ^ { 2 } } \bigg [ - \frac { 7 } { 2 } \partial _ { n } \tilde { V } \partial _ { n } \tilde { V } + \frac { 1 } { 2 } ( 2 \omega _ { 0 } + 3 ) \partial _ { n } f \partial _ { n } f \bigg ] + O ( c ^ { - 4 } ) , } \\ & { c ^ { - 1 } \tilde { \tau } ^ { 0 j } = \rho ^ { * } v ^ { j } + O ( c ^ { - 2 } ) , ~ ( 1 3 . 1 3 5 8 ) } \\ & { \qquad \tilde { \tau } ^ { j k } = \rho ^ { * } v ^ { j } v ^ { k } + p \delta ^ { j k } + \frac { 1 } { 4 \pi \tilde { G } } \bigg [ \partial _ { j } \tilde { V } \partial _ { k } \tilde { V } - \frac { 1 } { 2 } \delta _ { j k } \partial _ { n } \tilde { V } \partial _ { n } \tilde { V } } \\ & { \qquad + ( 2 \omega _ { 0 } + 3 ) \Big ( \partial _ { j } f \partial _ { k } f - \frac { 1 } { 2 } \delta _ { j k } \partial _ { n } f \partial _ { n } f \Big ) \bigg ] + O ( c ^ { - 2 } ) . } \end{array}
$$
...
$$
\begin{array} { r l } { \displaystyle c ^ { - 2 } \bar { \tau } ^ { 0 0 } = \rho ^ { * } \bigg \{ 1 + \frac { 1 } { c ^ { 2 } } \bigg [ \frac { 1 } { 2 } v ^ { 2 } + ( 3 - 4 \xi ) U + \Pi \bigg ] \bigg \} - \frac { 7 - 8 \xi } { 8 \pi G c ^ { 2 } } \alpha _ { k } U \partial _ { k } U } & { } \\ { \displaystyle + O ( c ^ { - 4 } ) , } & { ( ) } \\ { \displaystyle c ^ { - 1 } \bar { \tau } ^ { 0 j } = \rho ^ { * } v ^ { j } + O ( c ^ { - 2 } ) , } & { ( ) } \\ { \displaystyle \bar { \tau } ^ { k k } = \rho ^ { * } v ^ { 2 } + 3 p - \frac { 1 } { 8 \pi G } \partial _ { k } U \partial _ { k } U + O ( c ^ { - 2 } ) , } \\ { \displaystyle c ^ { - 2 } \tau _ { \mathrm { s } } = \frac { \xi \phi _ { 0 } } { 1 - \xi } \bigg [ \rho ^ { * } \bigg \{ 1 - \frac { 1 } { c ^ { 2 } } \bigg [ \frac { 1 } { 2 } v ^ { 2 } + ( 1 - 2 \xi + 4 \lambda ) U - \Pi + 3 p / \rho ^ { * } \bigg ] \bigg \} } & { } \\ { \displaystyle - \frac { \xi - \lambda } { 2 \pi G c ^ { 2 } } \partial _ { k } U \partial _ { k } U \bigg ] + O ( c ^ { - 4 } ) ; } & { ( ) } \end{array}
$$
...
$$
\begin{array} { l } { { a = g + { \displaystyle \frac { 1 } { M } } { \displaystyle \frac { d E _ { B } } { d h } } = g + { \displaystyle \frac { 1 } { M } } { \displaystyle \frac { d E _ { B } } { d G _ { \mathrm { e f f } } } } { \displaystyle \frac { d G _ { \mathrm { e f f } } } { d h } } = g + { \displaystyle \frac { 1 } { M } } { \displaystyle \frac { E _ { B } } { G } } \bigg ( - { \displaystyle \frac { \eta _ { N } g } { c ^ { 2 } } } \bigg ) G } } \\ { { = g \bigg ( 1 - \eta _ { N } { \displaystyle \frac { E _ { B } } { M c ^ { 2 } } } \bigg ) . } } \end{array}
$$
...
We next move to the far-away wave zone and examine the predictions of scalar–tensor gravity regarding generation of gravitational waves. We rely on the discussion of Sec. 7.1.4, which reveals that when the field point $( t , \boldsymbol { x } )$ is in the far-away wave zone, the potentials

$\tilde { h } ^ { \alpha \beta }$ can be expressed as the multipole expansion
...
$$
\begin{array} { r l } & { \mathcal { Z } _ { \mathrm { s } } ( \tau ) : = \displaystyle \int _ { \mathcal { M } } \tau _ { \mathrm { s } } ( \tau , x ) d ^ { 3 } x \ , } \\ & { \mathcal { Z } _ { \mathrm { s } } ^ { j } ( \tau ) : = \displaystyle \int _ { \mathcal { M } } \tau _ { \mathrm { s } } ( \tau , x ) x ^ { j } d ^ { 3 } x \ , } \\ & { \mathcal { Z } _ { \mathrm { s } } ^ { j k } ( \tau ) : = \displaystyle \int _ { \mathcal { M } } \tau _ { \mathrm { s } } ( \tau , x ) x ^ { j } x ^ { k } d ^ { 3 } x \ , } \end{array}
$$
...
$$
\begin{array} { r c l } { { } } & { { } } & { { \displaystyle \mathcal E ( \tau ) : = \int _ { \mathcal { M } } \mu ( \tau , x ) d ^ { 3 } x \ : , } } \\ { { } } & { { } } & { { \displaystyle \mathcal E ^ { j } ( \tau ) : = \int _ { \mathcal { M } } \mu ( \tau , x ) x ^ { j } d ^ { 3 } x \ : , } } \\ { { } } & { { } } & { { \displaystyle \mathcal E ^ { j k } ( \tau ) : = \int _ { \mathcal { M } } \mu ( \tau , x ) x ^ { j } x ^ { k } d ^ { 3 } x \ : , } } \end{array}
$$
