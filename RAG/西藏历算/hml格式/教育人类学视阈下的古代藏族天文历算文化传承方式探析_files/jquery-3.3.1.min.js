...
$.fn.popImg = function () {
    ...
    $window.on('click', function (evt) {
        ...
        if ($this.attr('pop-b-layer') || $this.attr('pop-b-img')) {
            $layer.fadeOut(300);
            $('img[pop-b-img]').remove();
            $("#okms_top", parent.document).children(".okms-top").removeClass("z-10"); //���top���ڵ�����
    ...
    return this.each(function () {
        ...
        $self.css('cursor', 'zoom-in').on('click', function () {
            ...
            $clone.appendTo($body);
            justifyImg($clone);
            $("#okms_top", parent.document).children(".okms-top").addClass("z-10"); //���top���ڵ�����
        });
    });
};
