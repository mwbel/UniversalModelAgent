...
UNIVMODEL_DIR = os.path.abspath(
    os.getenv("UNIVERSE_MODEL_SHARED_DIR", os.path.join(ROOT_DIR, "..", "..", ".."))
)
...
class Settings:
    ...
    port: int = int(os.getenv("APP_PORT", "8788"))
    app_name: str = os.getenv("APP_NAME", "Universe Model v0.2")
