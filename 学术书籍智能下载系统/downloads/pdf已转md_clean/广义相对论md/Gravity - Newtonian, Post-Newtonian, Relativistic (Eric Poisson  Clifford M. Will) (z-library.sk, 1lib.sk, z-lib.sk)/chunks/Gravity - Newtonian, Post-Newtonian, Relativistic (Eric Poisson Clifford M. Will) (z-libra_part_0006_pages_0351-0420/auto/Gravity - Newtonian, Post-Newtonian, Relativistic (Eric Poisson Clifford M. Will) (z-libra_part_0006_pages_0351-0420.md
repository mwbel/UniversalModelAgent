...
$$
\begin{array} { l } { { g _ { 0 0 } = - 1 + \displaystyle \frac 1 2 { h ^ { 0 0 } } - \frac 3 8 \bigl ( h ^ { 0 0 } \bigr ) ^ { 2 } + \frac 5 { 1 6 } \bigl ( h ^ { 0 0 } \bigr ) ^ { 3 } + \displaystyle \frac 1 2 { h ^ { k k } } \left( 1 - \frac 1 2 h ^ { 0 0 } \right) + \frac 1 2 h ^ { 0 j } h ^ { 0 j } } } \\ { { \qquad + O ( c ^ { - 8 } ) , \qquad } } \\ { { g _ { 0 j } = - h ^ { 0 j } \left( 1 - \frac 1 2 h ^ { 0 0 } \right) + O ( c ^ { - 7 } ) , \qquad } } \\ { { g _ { j k } = \delta _ { j k } \left[ 1 + \displaystyle \frac 1 2 h ^ { 0 0 } - \frac 1 8 \bigl ( h ^ { 0 0 } \bigr ) ^ { 2 } \right] + h ^ { j k } - \displaystyle \frac 1 2 \delta _ { j k } h ^ { m m } + O ( c ^ { - 6 } ) , \qquad } } \\ { { \qquad \quad } } \\ { { ( - g ) = 1 + h ^ { 0 0 } - h ^ { k k } + O ( c ^ { - 6 } ) . } } \end{array} \qquad \begin{array} { l } { { ( 1 ) } } \\ { { ( - h ^ { 0 0 } ) ^ { 2 } } } \\ { { ( 1 ) } } \\ { { ( - h ^ { 0 0 } ) ^ { 2 } } } \end{array}
$$
...
Examining Eqs. (7.23), we begin to see how different orders in the post-Newtonian expansion of $h ^ { \alpha \beta }$ contribute to the metric. Beginning with $g _ { 0 0 }$ , we see from Eq. (7.15) that $h ^ { 0 0 }$ contributes at all orders, from Newtonian order $( c ^ { - 2 } )$ through $2 . 5 \mathrm { { p N } }$ order $( c ^ { - 7 } )$ , that $h ^ { 0 j }$ contributes at $2 \mathrm { P N }$ order $( c ^ { - 6 } )$ only, and that $h ^ { j k }$ contributes at all orders beyond the Newtonian order $( c ^ { - 4 } , c ^ { - 5 } , c ^ { - 6 }$ , and $c ^ { - 7 }$ ). With $g _ { 0 j }$ we find that $h ^ { 0 0 }$ contributes at 2pn order $( c ^ { - 5 } )$ only, while $h ^ { 0 j }$ contributes at 1pn, 2pn, and $2 . 5 \mathrm { { p N } }$ orders $( c ^ { - 3 } , c ^ { - 5 }$ , and $c ^ { - 6 }$ ). And finally, with $g _ { j k }$ we see that $h ^ { 0 0 }$ contributes at 1pn, 2pn, and $2 . 5 \mathrm { { p N } }$ orders $( c ^ { - 2 } , c ^ { - 4 }$ , and $c ^ { - 5 }$ ), while $h ^ { j k }$ contributes at 2pn and $2 . 5 \mathrm { { p N } }$ orders $( c ^ { - 4 }$ and $c ^ { - 5 }$ ).
...
Our considerations in this chapter, and the three chapters that follow, will be limited to post-Newtonian gravity, in which corrections of 2pn order and higher are neglected. In this 1pn context our expansion for the metric can be truncated to

$$
\begin{array} { l } { { g _ { 0 0 } = - 1 + \displaystyle \frac { 1 } { 2 } h ^ { 0 0 } - \displaystyle \frac { 3 } { 8 } \bigl ( h ^ { 0 0 } \bigr ) ^ { 2 } + \displaystyle \frac { 1 } { 2 } h ^ { k k } + { \cal O } ( c ^ { - 6 } ) , } } \\ { { g _ { 0 j } = - h ^ { 0 j } + { \cal O } ( c ^ { - 5 } ) , } } \\ { { g _ { j k } = \delta _ { j k } \left( 1 + \displaystyle \frac { 1 } { 2 } h ^ { 0 0 } \right) + { \cal O } ( c ^ { - 4 } ) , } } \\ { { \displaystyle ( - g ) = 1 + h ^ { 0 0 } + { \cal O } ( c ^ { - 4 } ) . } } \end{array}
$$
...
We proceed with an examination of the general structure of the gravitational potentials when the field point $_ x$ is in the wave zone, where $r : = | { \mathbf { } } x | > \mathcal { R }$ . Consulting $\operatorname { B o x } 6 . 7$ once more, we see that we can express $h _ { \mathcal { N } } ^ { \alpha \beta }$ as the multipole expansion
...
Still according to Box 6.7, we see that the wave-zone contribution $h _ { \mathcal { W } } ^ { \alpha \beta }$ to the gravitational potentials is given by
...
$$
\begin{array} { l } { { { \cal M } ^ { \mathrm { R L } } = - \bar { z } ^ { 2 } \bar { z } ^ { L } , } } \\ { { { \cal M } ^ { \mathrm { R L } } = { \frac { c } { 2 ( \bar { \ell } + 1 ) } } ( \bar { \ell } ^ { L } - \bar { \ell } ^ { \mathrm { e r r } \bar { \mu } _ { 0 } } \bar { \ell } ^ { \mathrm { a n } \bar { z } - \bar { \ell } ^ { L } } ) ( \mathrm { s y m } a : L ) } } \\ { ~ } \\ { { \displaystyle ~ + { \frac { 1 } { ( \bar { \ell } + 1 ) } } \oint _ { \mathrm { s _ { \scriptscriptstyle M } } } \bar { \Psi } _ { x } ^ { \mathrm { R S } } { \cal M } _ { \bar { M } , \bar { \ell } } ~ } } \\ { { { \cal M } ^ { \mathrm { R L } } = { \frac { 1 } { ( \bar { \ell } + 1 ) ( \bar { \ell } + 2 ) } } { \bar { \bar { z } } } ^ { \bar { \mathrm { f i n } } \bar { \ell } + 1 } + { \frac { 2 } { ( \bar { \ell } + 2 ) } } ^ { \bar { \mathrm { e x t } } ( \bar { \ell } + 1 ) ( \bar { \ell } - \mathrm { s y m } _ { 0 } + \bar { \ell } ) ( \mathrm { s y m } _ { 0 } : L ) } } } \\ { { ~ + { \frac { 8 ( \bar { \ell } - 1 ) } { ( \bar { \ell } + 1 ) } } p \bar { \ell } ^ { \mathrm { a n } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { s } \mathrm { t } } } } \\  { ~ + { \frac { 1 } { ( \bar { \ell } + 1 ) ( \bar { \ell } + 2 ) } } \oint _ { \mathrm { s _ { \scriptscriptstyle M } } } \bar { \ell } ^ { \mathrm { r } \mathrm { e } ^ { \bar { \mathrm { f } } \bar { \mu } _ { 0 } } \bar { \nu } ( \mathrm { s y } ^ { \mathrm { f } \bar { \mu } _ { 0 } } ) + 3 { \bar { z } } ^ { \mathrm { t i m } _ { \bar { \nu } } \bar { \mu } _ { 0 } } \biggr \} d S _ { \mathrm { s } } } } \\    \displaystyle ~ - { \frac { 2 } { ( \bar { \ell } + 2 ) } } \oint _ { \mathrm { s y s } } [ \bar { \Psi } _ { x } ^ { \mathrm { f r o } } \bar { \Psi } _ { x } ^  \end{array}
$$
...
$$
\begin{array} { c } { { c ^ { - 2 } T _ { 0 } ^ { 0 0 } = \rho ^ { * } + { \cal O } ( c ^ { - 2 } ) , } } \\ { { { } } } \\ { { c ^ { - 1 } T _ { 0 } ^ { 0 j } = \rho ^ { * } v ^ { j } + { \cal O } ( c ^ { - 2 } ) , } } \\ { { { } } } \\ { { T _ { 0 } ^ { j k } = { \cal O } ( 1 ) . } } \end{array}
$$
...
In this section we face the challenging task of completing the second iteration of the relaxed field equations. Here we take the field point $\boldsymbol { x }$ to be in the near zone, so that $r < \mathcal { R }$ . The wave zone will be considered next, in Sec. 7.4.
...
$$
\begin{array} { l } { { { \frac { 1 6 \pi G } { c ^ { 4 } } } ( - g ) \displaystyle { \eta _ { \mathrm { L L } } ^ { j k } } = \frac { 1 } { 4 } \big ( 1 - 2 h ^ { 0 0 } \big ) \partial ^ { j } h ^ { 0 0 } \partial ^ { k } h ^ { 0 0 } - \frac { 1 } { 8 } \delta ^ { j k } \big ( 1 - 2 h ^ { 0 0 } \big ) \partial _ { n } h ^ { 0 0 } \partial ^ { n } h ^ { 0 0 } } } \\ { { \qquad \quad - \partial ^ { j } h ^ { 0 n } \partial ^ { k } h _ { n } ^ { 0 } + \partial ^ { j } h ^ { 0 n } \partial _ { n } h ^ { 0 k } + \partial ^ { k } h ^ { 0 n } \partial _ { n } h ^ { 0 j } - \partial _ { n } h ^ { 0 j } \partial ^ { n } h ^ { 0 k } } } \\ { { \qquad \quad + \partial ^ { j } h ^ { 0 0 } \partial _ { 0 } h ^ { 0 k } + \partial ^ { k } h ^ { 0 0 } \partial _ { 0 } h ^ { 0 j } + \frac { 1 } { 4 } \partial ^ { j } h ^ { 0 0 } \partial ^ { k } h _ { n } ^ { n } + \frac { 1 } { 4 } \partial ^ { k } h ^ { 0 0 } \partial ^ { j } h _ { n } ^ { n } } } \\ { { \qquad \quad + \delta ^ { j k } \bigg [ - \frac { 3 } { 8 } \big ( 3 _ { 0 } h ^ { 0 0 } \big ) ^ { 2 } - 3 n h ^ { 0 0 } \partial _ { 0 } h ^ { 0 n } - \frac { 1 } { 4 } \partial _ { n } h ^ { 0 0 } \partial ^ { n } h _ { p } ^ { p } } } \\ { { \qquad \quad \quad + \frac { 1 } { 2 } \partial _ { n } h _ { ~ p } ^ { 0 } \big ( \partial ^ { n } h ^ { 0 p } - \partial ^ { p } h ^ { 0 n } \big ) \bigg ] + { \cal O } ( c ^ { - 8 } ) . } } \end{array}
$$
...
$$
\tau _ { 1 } ^ { k k } = \rho ^ { * } \Biggl ( v ^ { 2 } - \frac { 1 } { 2 } U \Biggr ) + 3 p - \frac { 1 } { 1 6 \pi G } \nabla ^ { 2 } U ^ { 2 } + O ( c ^ { - 2 } )
$$
...
$$
\begin{array} { l } { \displaystyle \psi ( t , \pmb { x } ) : = G \int \frac { \rho ^ { \ast \prime } \big ( \frac { 3 } 2 v ^ { \prime 2 } - U ^ { \prime } + \Pi ^ { \prime } \big ) + 3 p ^ { \prime } } { \vert \pmb { x } - \pmb { x } ^ { \prime } \vert } d ^ { 3 } x ^ { \prime } , } \\ { \displaystyle V ( t , \pmb { x } ) : = G \int \frac { \rho ^ { \ast \prime } \big ( v ^ { \prime 2 } - \frac 1 2 U ^ { \prime } \big ) + 3 p ^ { \prime } } { \vert \pmb { x } - \pmb { x } ^ { \prime } \vert } d ^ { 3 } x ^ { \prime } , } \end{array}
$$
...
$$
\begin{array} { l } { { \displaystyle \frac { 1 } { 4 \pi } \int _ { \mathcal { M } } \frac { \nabla ^ { \prime 2 } U ^ { \prime 2 } } { | x - x ^ { \prime } | } d ^ { 3 } x ^ { \prime } = \frac { 1 } { 4 \pi } \oint _ { \partial _ { \mathcal { M } } } \frac { \partial ^ { \prime \prime } U ^ { \prime 2 } } { | x - x ^ { \prime } | } d S _ { j } ^ { \prime } - \frac { 1 } { 4 \pi } \int _ { \mathcal { M } } \partial ^ { \prime \prime } U ^ { \prime 2 } \partial _ { j } ^ { \prime } \frac { 1 } { | x - x ^ { \prime } | } d ^ { 3 } x ^ { \prime } } } \\ { { \displaystyle \qquad = \frac { 1 } { 4 \pi } \oint _ { \partial _ { \mathcal { M } } } \biggl ( \frac { \partial ^ { \prime \prime } U ^ { \prime 2 } } { | x - x ^ { \prime } | } - U ^ { \prime 2 } \partial _ { j } ^ { \prime } \frac { 1 } { | x - x ^ { \prime } | } \biggr ) d S _ { j } ^ { \prime } } } \\ { { \displaystyle \qquad + \frac { 1 } { 4 \pi } \int _ { \mathcal { M } } U ^ { \prime 2 } \nabla ^ { \prime 2 } \frac { 1 } { | x - x ^ { \prime } | } d ^ { 3 } x ^ { \prime } } } \\ { { \displaystyle \qquad = - U ^ { 2 } + \frac { 1 } { 4 \pi } \oint _ { \partial _ { \mathcal { M } } } \biggl ( \frac { \partial ^ { \prime \prime } U ^ { \prime 2 } } { | x - x ^ { \prime } | } - U ^ { \prime 2 } \partial _ { j } ^ { \prime } \frac { 1 } { | x - x ^ { \prime } | } \biggr ) d S _ { j } ^ { \prime } . \quad \qquad ( } } \end{array}
$$

The surface term is evaluated at $r ^ { \prime } = \mathcal { R }$ , and because $U ^ { \prime }$ falls off as $( r ^ { \prime } ) ^ { - 1 }$ at large distances from the matter distribution, it makes a contribution that scales as $\mathcal { R } ^ { - 2 }$ . As with all $\mathcal { R }$ - dependent terms in the potentials $h _ { \mathcal { N } } ^ { \alpha \beta }$ , we may discard it because it will eventually be cancelled by an equal and opposite term in $h _ { \mathcal { W } } ^ { \alpha \beta }$ .
...
$$
\begin{array} { l } { { { \displaystyle h _ { 2 { \mathcal N } } ^ { 0 0 } = \frac { 4 } { c ^ { 2 } } U + \frac { 1 } { c ^ { 4 } } \bigg ( 7 U ^ { 2 } + 4 \psi - 4 V + 2 \frac { \partial ^ { 2 } X } { \partial t ^ { 2 } } \bigg ) - \frac { 2 G } { 3 c ^ { 5 } } { \dddot { \mathcal Z } } ^ { k k } ( t ) + { \cal O } ( c ^ { - 6 } ) , } } } \\ { { { \displaystyle h _ { 2 { \mathcal N } } ^ { k k } = \frac { 1 } { c ^ { 4 } } \bigg ( U ^ { 2 } + 4 V \bigg ) - 2 \frac { G } { c ^ { 5 } } { \dddot { \mathcal Z } } ^ { k k } ( t ) + { \cal O } ( c ^ { - 6 } ) . } } } \end{array}
$$
...
<table><tr><td>Box 7.3</td><td>Definition of the superpotential</td></tr><tr><td></td><td>Thepost-NewtoniansuperpotentialXisdefinedbyEq.(7.76),andthisleadstothePissonequationdisplaed in Eq. (7.77). Here we ask whether defining the superpotential through</td></tr><tr><td></td><td>V²X = 2U</td></tr><tr><td></td><td>necessarily leads back tothe integral representationofEq.(7.76).We shallseethattheanswertothis ques-</td></tr><tr><td></td><td>tion is subtle,and provides furtherillustration of the fact that boundary conditions and solutions to Laplace&#x27;s equation sometimes play an important role in solving Poisson&#x27;s equation.</td></tr></table>
...
$$
X ( t , x ) = G \int \rho ^ { * } ( t , x ^ { \prime } ) | x - x ^ { \prime } | d ^ { 3 } x ^ { \prime } - 2 G m \mathcal { R } + X _ { 0 } ( t , x ) ,
$$

with $\begin{array} { r } { m : = \int \rho ^ { \ast } ( t , \pmb { x } ^ { \prime } ) d ^ { 3 } x ^ { \prime } } \end{array}$ denoting the total rest-mass of the matter distribution. Choosing $X _ { 0 } =$ $2 G m \mathcal R ,$ we reproduce the original definition of the superpotential.

It is interesting to note that since it is $\partial _ { t } ^ { 2 } {  \boldsymbol { X } }$ that appears in the gravitational potentials, the addition of $- 2 G m \mathcal { R } + X _ { 0 }$ to the integral is immaterial, so long as $X _ { 0 }$ does not depend on time. The superpotential, therefore, is sufficiently robust to withstand the ambiguities associated with the choice of solution to $\nabla ^ { 2 } X = 2 U$ .
...
$$
\chi ^ { j k } = G ^ { 2 } \int d ^ { 3 } y _ { 1 } d ^ { 3 } y _ { 2 } \rho _ { 1 } ^ { * } \rho _ { 2 } ^ { * } \frac { \partial ^ { 2 } } { \partial y _ { 1 } ^ { j } \partial y _ { 2 } ^ { k } } K ( { \pmb x } ; { \pmb y } _ { 1 } , { \pmb y } _ { 2 } ) ,
$$
...
is a three-point function that must now be evaluated. This computation is presented in Box 7.4, and the end result is
...
$$
\frac { \partial ^ { 2 } K } { \partial y _ { 1 } ^ { j } \partial y _ { 2 } ^ { k } } = \frac { \left( n _ { 1 } ^ { j } - n _ { 1 2 } ^ { j } \right) \left( n _ { 2 } ^ { k } + n _ { 1 2 } ^ { k } \right) } { S ^ { 2 } } - \frac { n _ { 1 2 } ^ { j } n _ { 1 2 } ^ { k } - \delta ^ { j k } } { S r _ { 1 2 } } .
$$
...
To this we must add a suitable solution $K _ { \mathrm { h } }$ to Laplace’s equation. The solution to the homogeneous equation must be non-singular in all three variables $x , y _ { 1 } ,$ and $y _ { 2 }$ , because the singularity structure required by Eq. (1) is already contained in $K _ { \mathfrak { p } }$ . Furthermore, $K _ { \mathrm { h } }$ must be dimensionless, and the only possibility is to make it equal to a constant. We are therefore looking for a solution of the form
...
To reach this conclusion we refer to Eq. (6.107), which applies to source terms of the form displayed in Eq. (6.98). In our current application, $\tau _ { 1 } ^ { \alpha \beta }$ is built entirely from $( - g ) t _ { \mathrm { L L } } ^ { \alpha \beta }$
...
This is of order $c ^ { - 8 }$ , and contributes to $h _ { 2 } ^ { 0 0 }$ at $3 \mathrm { P N }$ order. A similar result follows for the other components of $h _ { \mathcal { W } } ^ { \alpha \beta }$ , and we arrive at the statement of Eq. (7.101).

In fact, a detailed computation shows that these contributions are actually gauge artifthat can be removed by a suitable coordinate transformation. The first instance in which $h _ { \mathcal { W } } ^ { \alpha \beta }$ any event, we see that $h _ { \mathcal { W } } ^ { \alpha \beta }$ is far too small to contribute to our 1pn potentials, and for this reason we do not need to calculate it in detail.
...
<table><tr><td>Box 7.5</td><td>Near-zone potentials</td></tr><tr><td></td><td>Combining Eq.(7.78),(7.79),(85),nd(.),datthear-egraviatiolpoteteie by 2G(1)+0(c6， +(7U²+4-4V+2 d²x) n2 U + at² 3c5I</td></tr></table>
...
$$
\begin{array} { r l } & { \quad ( x - \xi ^ { \prime } ) \Bigg [ \frac { \partial ^ { \alpha } } { \partial x } x ^ { \alpha } \Bigg ] ^ { \beta } , } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad }  \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & \end{array}
$$

The potentials are evaluated at time $t$ and position $x ;$ the sources are evaluated at the same time but at position $\mathbf { \Delta } _ { \mathbf { { x } ^ { \prime } } }$ . We use the notation $\pmb { r } _ { 1 } : = \pmb { x } - \pmb { y } _ { 1 } , \pmb { r } _ { 1 } : = | \pmb { r } _ { 1 } | , \pmb { n } _ { 1 } : = \pmb { r } _ { 1 } / r _ { 1 }$ (and similarly for $r _ { 2 } , r _ { 2 } ,$ and ${ \pmb n } _ { 2 } )$ , as well $\mathfrak { a s } r _ { 1 2 } : = { \pmb { y } } _ { 1 } - { \pmb { y } } _ { 2 } , r _ { 1 2 } : = | { \pmb { r } } _ { 1 2 } |$ , and ${ \pmb n } _ { 1 2 } : = { \pmb r } _ { 1 2 } / r _ { 1 2 }$ , in which $_ { y _ { 1 } }$ and $y _ { 2 }$ are integration variables. We also have $S : = r _ { 1 } + r _ { 2 } + r _ { 1 2 } ,$ and the trace of $\chi ^ { j k }$ is given by
...
<table><tr><td>Box 7.6</td><td>Post-Minkowskian theory and the slow-motion approximation</td></tr><tr><td></td><td>The advantages of incorporatingasow-motion condition within post-Minkowskian theoryshould be pretty</td></tr><tr><td></td><td> clear by now, quite apart from the physical relevance of slow motion within a weak-field context. Had we not</td></tr><tr><td></td><td>expanded the various retarded potentials in powers of c-1 right from the start, we would have been faced</td></tr></table>
...
$$
\begin{array} { l } { { { \bar { t } _ { \mathcal { N } ^ { \prime } } ^ { [ i ] } } = \displaystyle { \frac { 4 G ^ { 4 } } { \omega ^ { \prime } } } = \frac { 2 G ^ { 4 } } { \omega ^ { \prime } } \displaystyle { \frac { \left[ \frac { \gamma ^ { i } ( n _ { \ell } ) } { f } - \tau \right] } { \nu ^ { N } } } \displaystyle { \frac { \left[ \frac { 2 \ell ^ { i } ( n _ { \ell } ) } { f } \right] } { \nu ^ { N } } } - \displaystyle { \frac { 2 G ^ { 2 } } { 3 \omega ^ { \prime } } } j i \displaystyle { \frac { \left[ \frac { \gamma ^ { i } ( n _ { \ell } ) } { f } \right] } { \lambda ^ { \frac { 3 } { 1 } } \nu ^ { N } } } + \cdots , } } \\ { { \displaystyle { \bar { t } _ { \mathcal { N } ^ { \prime } } ^ { [ i ] } } = - \displaystyle { \frac { 2 G ^ { 4 } } { \omega ^ { \prime } } } \displaystyle { \frac { ( n _ { \ell } \times n _ { f } ) ^ { i } } { | \nu ^ { N } } } - \displaystyle { \frac { \frac { 2 G } { 3 \omega } } { \omega ^ { \prime } } } \displaystyle { \left[ \frac { \frac { \gamma ^ { i } ( n _ { \ell } ) } { f } - \tau } { \nu } \right] } } } \\ { { \displaystyle \quad - \displaystyle { \frac { G } { 3 \omega ^ { \prime } } } { \bar { s } } { \bar { s } } _ { \ell } \displaystyle { \left[ \frac { \frac { \gamma ^ { i } ( n _ { \ell } ) } { f } - \tau } { \nu } - \frac { 2 G ^ { i } \nu _ { f } ^ { i } \nu _ { f } ^ { i , n _ { \ell } } ( \tau ) } { \nu } \right] } + \cdots , \ } } \\   \displaystyle { \bar { t } _ { \mathcal { N } ^ { \prime } } ^ { [ i ] } } = \displaystyle { \frac { 2 G ^ { 4 } { \bar { s } } ^ { [ i ] } \nu ^ { i } } { \nu ^ { N } } } - \displaystyle { \frac { 2 G } { 3 \omega ^ { \prime } } } { \bar { t } _ { \mathcal { N } ^ { \prime } } } { \displaystyle \frac { \left[ \frac { \gamma ^ { i } \mu _ { \ell } ^ { n } ( \tau ) + 4 e ^ { i } \rho ^ { i } \rho ^ { i } \nu _ { \ell } ( \tau ) } { \nu ^ { i } } \right] } + \cdots } \end{array}
$$
...
$$
\begin{array} { l } { { \displaystyle \tau _ { 1 } ^ { 0 0 } = - \frac { 7 G M ^ { 2 } } { 8 \pi r ^ { 4 } } + { \cal O } ( c ^ { - 2 } ) , } } \\ { { \displaystyle \tau _ { 1 } ^ { 0 j } = { \cal O } ( c ^ { - 3 } ) , } } \\ { { \displaystyle \tau _ { 1 } ^ { j k } = \frac { G M ^ { 2 } } { 4 \pi r ^ { 4 } } \bigg ( n ^ { j } n ^ { k } - \frac { 1 } { 2 } \delta ^ { j k } \bigg ) + { \cal O } ( c ^ { - 2 } ) , } } \end{array}
$$
...
<table><tr><td>Box 7.7</td><td>Wave-zone fields</td></tr><tr><td></td><td colspan="3">Combining Eqs. (7.107)and (7.115), we find that the wave-zone gravitational potentials are given by 4GM (Tjkn) 7 GM²</td></tr><tr><td rowspan="8"></td><td>4[+0( h0 = 【+] aikn 4 c²r² 3(m-m）+</td></tr><tr><td>() h0i = 1 Okn(</td></tr><tr><td>[2r² 12 r</td></tr><tr><td>(Tikn + 2emn jmk +2emnk mj) 4G[11jk 1 GM²</td></tr><tr><td>[n&#x27;n+.]. hjk = [2r a + 4r2 r</td></tr><tr><td>The potentials are expressed in terms ofn = xj/r,andin terms of multipole moments that depend on retarded time T = t - r/c; overdots indicate differentiation with respect to t.In ho0 the mass term con-</td></tr></table>
...
$$
J = \int { \rho } ^ { * } \pmb { x } \times \pmb { v } d ^ { 3 } x + O ( c ^ { - 2 } ) ,
$$
...
We recall that $M$ and $\pmb { J }$ are conserved quantities. The gravitational potentials are evaluated in the center-ofmass frame, in which the total momentum $P$ and center- $\cdot 0 \mathsf { f } .$ -mass position $\pmb { R }$ are set equal to zero.
...
where $\begin{array} { r } { F ( t ) : = \int \rho ^ { * } ( t , \pmb { x } ) f ( t , \pmb { x } ) d ^ { 3 } \pmb { x } } \end{array}$ and $d f / d t = \partial _ { t } f + v ^ { j } \partial _ { j } f ;$ this is established on the basis of the continuity equation $\partial _ { t } \rho ^ { * } + \partial _ { j } ( \rho ^ { * } v ^ { j } ) = 0$ , as shown back in Sec. 1.4.3. The terms involving $d { \pmb v } / d t$ are handled by invoking Euler’s equation $\rho ^ { * } ( d v ^ { j } / d t ) = \rho ^ { * } \partial ^ { j } U - \partial ^ { j } p + O ( c ^ { - 2 } ) ,$ which was shown in Sec. 7.3.2 to be a consequence of energy-momentum conservation.
...
Show that the surface term satisfies Laplace’s equation for any point $_ { x }$ within the near zone.
...
7.6 Show that the quadrupole-moment piece of the wave-zone potential $h ^ { 0 0 }$ in $\mathrm { B o x } 7 . 7$ i s given explicitly by
...
7.7 For a static, spherically-symmetric source, show that the wave-zone potentials given in Box 7.7 reduce to
...
$$
{ \cal M } = { \cal M } _ { 0 } - \frac { 2 } { 3 } \frac { G M _ { 0 } } { c ^ { 5 } } \dddot { \mathcal { T } } ^ { k k } ( \tau ) + { \cal O } ( c ^ { - 7 } ) .
$$
...
$$
\begin{array} { l } { { g _ { 0 0 } = - 1 + \displaystyle \frac { 2 } { c ^ { 2 } } U + \displaystyle \frac { 2 } { c ^ { 4 } } \left( \Psi - U ^ { 2 } \right) + { \cal O } ( c ^ { - 5 } ) , } } \\ { { \displaystyle g _ { 0 j } = - \displaystyle \frac { 4 } { c ^ { 3 } } U _ { j } + { \cal O } ( c ^ { - 5 } ) , } } \\ { { \displaystyle g _ { j k } = \delta _ { j k } \left( 1 + \displaystyle \frac { 2 } { c ^ { 2 } } U \right) + { \cal O } ( c ^ { - 4 } ) , } } \end{array}
$$
...
$$
\begin{array} { c } { { { \displaystyle c ^ { - 2 } T ^ { 0 0 } = \rho ^ { * } \biggl [ 1 + \frac { 1 } { c ^ { 2 } } \Bigl ( \frac { 1 } { 2 } v ^ { 2 } - U + \Pi \Bigr ) \biggr ] + { \cal O } ( c ^ { - 4 } ) , } } } \\ { { { } } } \\ { { { \displaystyle c ^ { - 1 } T ^ { 0 j } = \rho ^ { * } v ^ { j } \biggl [ 1 + \frac { 1 } { c ^ { 2 } } \Bigl ( \frac { 1 } { 2 } v ^ { 2 } - U + \Pi + p / \rho ^ { * } \Bigr ) \biggr ] + { \cal O } ( c ^ { - 4 } ) , } } } \\ { { { } } } \\ { { { \displaystyle T ^ { j k } = \rho ^ { * } v ^ { j } v ^ { k } \biggl [ 1 + \frac { 1 } { c ^ { 2 } } \Bigl ( \frac { 1 } { 2 } v ^ { 2 } - U + \Pi + p / \rho ^ { * } \Bigr ) \biggr ] + p \biggl ( 1 - \frac { 2 } { c ^ { 2 } } U \biggr ) \delta ^ { j k } } } } \\ { { { } } } \\ { { { \displaystyle ~ + { \cal O } ( c ^ { - 4 } ) , } } } \end{array}
$$
...
$$
\begin{array} { r l } & { \Phi _ { 1 } : = G \int \frac { \rho ^ { \sigma } v ^ { 2 } } { | x - x | ^ { 2 } } d ^ { 3 } x ^ { \prime } , } \\ & { \Phi _ { 2 } : = G \int \frac { \rho ^ { \sigma } v ^ { 2 } } { | x - x | ^ { 2 } } d x ^ { \prime } , } \\ & { \Phi _ { 3 } : = G \int \frac { \rho ^ { \sigma } v ^ { 1 } } { | x - x | ^ { 2 } } d ^ { 3 } x ^ { \prime } , } \\ & { \Phi _ { 4 } : = G \int \frac { \rho ^ { \sigma } v ^ { 2 } } { | x - x | ^ { 2 } } d ^ { 3 } x ^ { \prime } , } \\ & { \Phi _ { 5 } : = G \int \rho ^ { \sigma } \partial _ { \cal J } \psi \frac { ( x - x ) ^ { \prime } } { | x - x | ^ { 2 } } d ^ { 3 } x ^ { \prime } , } \\ & { \Phi _ { 5 } : = G \int \rho ^ { \sigma } v ^ { 3 } \psi \frac { ( x - x ) ^ { \prime } ( x - x ) ^ { \prime } } { | x - x | ^ { 3 } } d ^ { 3 } x ^ { \prime } , } \\ & { \Phi _ { 6 } : = G \int \rho ^ { \sigma } v _ { 5 } ^ { 3 } \psi \frac { ( x - x ) ^ { \prime } ( x - x ) ^ { \prime } } { | x - x | ^ { 3 } } d ^ { 3 } x ^ { \prime } . } \end{array}
$$
...
<table><tr><td>Box 8.1</td><td>Maxwell-like formulation of post-Newtonian theory</td></tr><tr><td></td><td>The main equations of post-Newtonian theory can be writen in a form that displays a remarkable parallel with the equations of electrodynamics.These consist of Maxwel&#x27;s equations,</td></tr><tr><td></td><td>1 V.E=-ρe,</td></tr><tr><td></td><td>E0</td></tr><tr><td></td><td>V .B=0,</td></tr><tr><td></td><td>V × E=-dtB,</td></tr><tr><td></td><td>V × B= (=je+dE), c2</td></tr></table>
...
From the post-Newtonian metric (8.2), we first define a gravito-electric potential $\Phi _ { \mathrm { g } } : = - { \textstyle \frac { 1 } { 2 } } c ^ { 2 } ( 1 +$ $g _ { 0 0 } ) = - U - c ^ { - 2 } ( \Phi - U ^ { 2 } ) + O ( c ^ { - 4 } )$ and a gravito-magnetic potential $A _ { \mathrm { g } }$ with components $c g _ { 0 j } = - 4 c ^ { - 2 } U _ { j } + { \cal O } ( c ^ { - 4 } )$ . We next define a gravito-electric field $\pmb { { \cal E } } _ { \mathrm { g } } : = - \nabla \Phi _ { \mathrm { g } } - \partial _ { t } { \cal A } _ { g }$ $= \nabla U + c ^ { - 2 } ( \nabla \Psi - \nabla U ^ { 2 } + 4 \partial _ { t } U )$ and a gravito-magnetic field $\pmb { { \cal B } } _ { \mathrm { g } } : = \nabla \times { \cal A } _ { \mathrm { g } } =$ $- 4 c ^ { - 2 } \nabla \times \pmb { U } ;$ ; the relations between potentials and fields are the same as in electrodynamics. It is then a simple matter to show that the field equations of post-Newtonian theory can be put in the Maxwell-like form
...
$$
\Psi = \psi + \frac { 1 } { 2 } \partial _ { t t } { \cal { F } } ,
$$
...
<table><tr><td>Box 8.2</td><td>Post-Newtonian transformations</td></tr><tr><td></td><td>The most generalcoordinate ransformation that preserves the post-Newtonian ordering ofthe metric is given by</td></tr><tr><td></td><td>1 1 t=t+ T a(t，xi) β(t,xi）+0(c-6），</td></tr><tr><td></td><td>xj=xi+rj(t)+ h(t，xi)+O(c-4)，</td></tr></table>
...
$$
\begin{array} { l } { { F ^ { j } = H ^ { j } - { \cal A } \upsilon ^ { j } , } } \\ { { \displaystyle } } \\ { { F _ { k } ^ { j } = - \delta _ { k } ^ { j } \Big ( \dot { \cal A } - \frac 1 2 { \upsilon } ^ { 2 } \Big ) - \frac 1 2 { \upsilon } ^ { j } { \upsilon } _ { k } + \epsilon _ { k p } ^ { j } { \cal R } ^ { p } , } } \\ { { \displaystyle } } \\ { { F _ { k n } ^ { j } = - \big ( \delta _ { k } ^ { j } a _ { n } + \delta _ { n } ^ { j } a _ { k } \big ) + \delta _ { k n } a ^ { j } , } } \end{array}
$$
...
$$
\partial _ { \bar { \boldsymbol { J } } } \alpha = { \left( { \boldsymbol { v } } ^ { k } + { \dot { R } } _ { n } ^ { k } { \bar { \boldsymbol { x } } } ^ { n } \right) } R _ { k j } ;
$$
...
<table><tr><td>Box 8.3</td><td>Rotating coordinates</td></tr><tr><td></td><td>By forcing goj to vanish at order c-1，we areconsciously excluding rotating cordinate systems from the allowed class of post-Newtonian coordinates. To describe a purely rotating coordinate system, we would use the transformation t =𝜉+O(c-4)， x𝑗 = R()x𝑘 +O(c-²)，</td></tr></table>
...
$$
\bar { U } _ { j } = \hat { U } _ { j } - v _ { j } \hat { U } + \frac { 1 } { 4 } \bigg ( V _ { j } + V _ { j k } \bar { x } ^ { k } + \frac { 1 } { 2 } V _ { j k n } \bar { x } ^ { k } \bar { x } ^ { n } + \partial _ { \bar { \jmath } } \beta \bigg ) ,
$$
...
$$
\begin{array} { l } { { \displaystyle \bar { \Psi } = \hat { \Psi } + 2 v ^ { 2 } \hat { U } + \alpha \partial _ { \bar { t } } \hat { U } + ( h ^ { j } - \alpha v ^ { j } ) \partial _ { \bar { \cal J } } \hat { U } - 4 v _ { j } \hat { U } ^ { j } } } \\ { { \displaystyle ~ + \frac { 1 } { 2 } ( \partial _ { \bar { t } } \alpha ) ^ { 2 } - v ^ { 2 } \partial _ { \bar { t } } \alpha + \frac { 1 } { 4 } v ^ { 4 } - \partial _ { \bar { t } } \beta + v _ { j } \partial _ { \bar { t } } h ^ { j } . } } \end{array}
$$

After taking into account Eqs. (8.42) and (8.51), we finally arrive at

$$
\begin{array} { r l r } {  { \bar { \Psi } = \hat { \Psi } - 4 v _ { j } \hat { U } ^ { j } + 2 v ^ { 2 } \hat { U } + \bigl ( A + v _ { k } \bar { x } ^ { k } \bigr ) \partial _ { \bar { t } } \hat { U } + \Bigl ( F ^ { j } + F _ { k } ^ { j } \bar { x } ^ { k } + \frac 1 2 F _ { k n } ^ { j } \bar { x } ^ { k } \bar { x } ^ { n } \Bigr ) \partial _ { \bar { j } } \hat { U } } } \\ & { } & \\ & { } & { \qquad + G + G _ { j } \bar { x } ^ { j } + \frac 1 2 G _ { j k } \bar { x } ^ { j } \bar { x } ^ { k } - \partial _ { \bar { t } } \beta , \qquad ( \bar { \hat { \mathbf { x } } } ^ { j } + F _ { \mathrm { ~ e ~ f ~ f ~ } } ^ { j } \bar { x } ^ { k } + \frac 1 2 F _ { k n } ^ { j } \bar { x } ^ { k } \bar { x } ^ { n } \Bigr ) \partial _ { \bar { j } } \hat { U } } \\ & { } & { \qquad ( \bar { \hat { \mathbf { x } } } ^ { j } + F _ { \mathrm { ~ e ~ f ~ } } ^ { j } \bar { x } ^ { j } + \frac 1 2 G _ { j k } \bar { x } ^ { j } \bar { x } ^ { k } - \partial _ { \bar { t } } \beta , \qquad ( \bar { \hat { \mathbf { x } } } ^ { j } + F _ { \mathrm { ~ e ~ f ~ f ~ } } ^ { j } \bar { x } ^ { k } ) ^ { n } \partial _ { \bar { t } } \hat { U } } \\ & { } & { \qquad ( \bar { \hat { \mathbf { x } } } ^ { j } + F _ { j } \bar { x } ^ { j } ) ^ { \perp } , } \end{array}
$$
...
$$
U _ { \mathrm { e x t } } = U ( t , r ^ { j } ) + ( x - r ) ^ { j } \partial _ { j } U _ { \mathrm { e x t } } ( t , r ^ { j } ) + \frac { 1 } { 2 } ( x - r ) ^ { j } ( x - r ) ^ { k } \partial _ { j k } U _ { \mathrm { e x t } } ( t , r ^ { j } ) + \cdots .
$$
...
![](images/436e8b37cf66174a5de95e0a08b8e6362e56935a378a3cd7e088e1a69589764f.jpg)  
World line of a selected fluid element viewed in the frame S. The grey plane is a hypersurface $t = \mathsf { c o }$ nstant, and the white plane is a hypersurface $\bar { t } =$ constant. The field point $P { \mathrm { i } } s$ simultaneous with $Q ^ { \prime }$ in S, but it is simultaneous with $P ^ { \prime }$ in the frame ¯S.

We want to express $\mathbf { \Delta } _ { \mathbf { { x } ^ { \prime } } }$ in terms of $\bar { t } , \bar { x }$ , and $\bar { x } ^ { \prime }$ , and this requires elimination of $\bar { \tau }$ and $\bar { \pmb \xi }$ from Eqs. (8.87b). To achieve this we equate the $t$ of Eqs. (8.85) with the $t$ of Eqs. (8.87) and deduce that $\bar { \tau } = \bar { t } + c ^ { - 2 } V _ { j } ( \bar { x } - \bar { \xi } ) ^ { j } + O ( c ^ { - 4 } )$ . We substitute this into the world-line equation $\bar { \pmb \xi } = \bar { \pmb r } ( \bar { \tau } )$ and get $\bar { \xi } ^ { j } = \bar { x } ^ { \prime j } + c ^ { - 2 } \bar { v } ^ { \prime j } V _ { k } ( \bar { x } - \bar { \xi } ) ^ { k } + O ( c ^ { - 4 } )$ . Collecting results, we have obtained
...
$$
\begin{array} { l } { { \Phi _ { 1 } = \bar { \Phi } _ { 1 } + 2 V ^ { j } \bar { U } _ { j } + V ^ { 2 } \bar { U } + O ( c ^ { - 2 } ) , } } \\ { { \Phi _ { 2 } = \bar { \Phi } _ { 2 } + O ( c ^ { - 2 } ) , } } \\ { { \Phi _ { 3 } = \bar { \Phi } _ { 3 } + O ( c ^ { - 2 } ) , } } \\ { { \Phi _ { 4 } = \bar { \Phi } _ { 4 } + O ( c ^ { - 2 } ) , } } \\ { { \Phi _ { 5 } = \bar { \Phi } _ { 5 } + O ( c ^ { - 2 } ) , } } \\ { { \Phi _ { 6 } = \bar { \Phi } _ { 6 } + 2 V ^ { j } \bar { \Phi } _ { j } + V ^ { 2 } \bar { U } - V ^ { j } V ^ { k } \partial _ { j k } \bar { X } + O ( c ^ { - 2 } ) . } } \end{array}
$$
...
Our final task is to verify that the transformed metric $\bar { g } _ { \alpha \beta }$ takes the standard post-Newtonian form of Eq. (8.20) when it is expressed in terms of the transformed potentials $\bar { U } , \bar { U } ^ { j }$ , and $\bar { \Psi }$ . This is straightforward. We first specialize the general transformation equations (8.34) to the post-Galilean case of Eqs. (8.85) and get the components $\bar { g } _ { 0 0 } =$ $- 1 + 2 c ^ { - 2 } U + 2 c ^ { - 4 } ( \Psi - U ^ { 2 } - 4 V ^ { j } U _ { j } + 2 V ^ { 2 } U ) + O ( c ^ { - 6 } ) , \bar { g } _ { 0 j } = - 4 c ^ { - 3 } ( U _ { j } - V _ { j } U ) + O ( c ^ { 0 } ) ,$ $O ( c ^ { - 5 } )$ , and $\bar { g } _ { j k } = \delta _ { j k } ( 1 + 2 c ^ { - 2 } U ) + O ( c ^ { - 4 } )$ for the new metric tensor. This is still expressed in terms of the old potentials, and we complete the calculation by involving Eqs. (8.93), (8.94), and (8.96). Our final result is
...
$$
\begin{array} { c } { { \mu \rho ^ { * } \displaystyle \frac { d v ^ { j } } { d t } = - \partial _ { j } p + \rho ^ { * } \partial _ { j } U - \displaystyle \frac { 1 } { c ^ { 2 } } v ^ { j } \partial _ { t } p + \displaystyle \frac { 1 } { c ^ { 2 } } \rho ^ { * } \bigg ( \displaystyle \frac { 3 } { 2 } v ^ { 2 } - 3 U + \Pi + \frac { p } { \rho ^ { * } } \bigg ) \partial _ { j } U } } \\ { { - \displaystyle \frac { 1 } { c ^ { 2 } } \rho ^ { * } \Big [ v ^ { j } \big ( 3 \partial _ { t } U + 4 v ^ { k } \partial _ { k } U \big ) - 4 \partial _ { t } U _ { j } - 4 v ^ { k } \big ( \partial _ { k } U _ { j } - \partial _ { j } U _ { k } \big ) - \partial _ { j } \Psi \Big ] + { \cal O } ( c ^ { - 4 } ) . } } \end{array}
$$
...
We now interrupt the main development and establish a number of identities that will be required in the following discussion. We first derive the results displayed back in Eqs. (8.10), and next we prove the integral identities

$$
\begin{array} { l } { \displaystyle \int \rho ^ { * } \partial _ { t } U d ^ { 3 } x = 0 , } \\ { \displaystyle \int \rho ^ { * } U ^ { i } \partial _ { x } ^ { 3 } = \int \rho ^ { * } U ^ { i } d ^ { 3 } x , } \\ { \displaystyle \int \rho ^ { * } \partial _ { t } \phi ^ { \lambda } _ { x } = - \int \rho ^ { * } ( \frac { \partial } { \partial x ^ { i } } ) ^ { 2 } d ^ { 3 } x , } \\ { \displaystyle \int \rho ^ { * } \nu ^ { * } \partial _ { t } U ^ { i } = \frac { 1 } { 2 } \frac { d } { d t } \int \rho ^ { * } U ^ { i } { \partial ^ { 3 } } x , } \\ { \displaystyle \int \rho ^ { * } \nu ^ { * } \partial _ { t } U d ^ { 3 } x = 0 , } \\ { \displaystyle \int \rho ^ { * } \nu ^ { * } \partial _ { t } \phi _ { x } = 0 , } \\ { \displaystyle \int \rho ^ { * } \nu ^ { * } \partial _ { t } U d ^ { 3 } x = 0 , } \\ { \displaystyle \int \rho ^ { * } \nu ^ { * } \partial _ { t } U d ^ { 3 } x = \int \rho ^ { * } \Phi ^ { i } d ^ { 3 } x . } \end{array}
$$
...
$$
\int \rho ^ { * } v ^ { k } \partial _ { t j k } X d ^ { 3 } x = 0 ,
$$
...
$$
\partial _ { t } F = \int { \rho } ^ { \ast \prime } \big ( \partial _ { t } f + v ^ { \prime k } \partial _ { k ^ { \prime } } f \big ) d ^ { 3 } x ^ { \prime } ,
$$

where $\boldsymbol { v } ^ { \prime k }$ is the velocity field expressed as a function of t and $\mathbf { \Delta } _ { \mathbf { { x } ^ { \prime } } }$ , and $\partial _ { k ^ { \prime } }$ indicates partial differentiation with respect to the primed coordinates. The total time derivative of $F$ is $\partial _ { t } F + v ^ { k } \partial _ { k } F$ , and this can be expressed as $\begin{array} { r } { d F / d t = \int \rho ^ { * \prime } ( \partial _ { t } f + v ^ { k } \partial _ { k } f + v ^ { \prime k } \partial _ { k ^ { \prime } } f ) d ^ { 3 } x ^ { \prime } } \end{array}$ . The quantity within brackets is recognized as the total time derivative of the function $f ( t , x , x ^ { \prime } )$ , and we write our identity as
...
$$
\partial _ { t j } X = - G \int \rho ^ { * \prime } v _ { k } ^ { \prime } \partial _ { j } \frac { ( x - x ^ { \prime } ) ^ { k } } { | x - x ^ { \prime } | } d ^ { 3 } x ^ { \prime } ,
$$
...
We recognize this as the time derivative of ${ \textstyle \frac { 1 } { 2 } } \int \rho ^ { * } U d ^ { 3 } x$ , and we have established Eq. (8.120d).

The identities of Eqs. (8.120e) and (8.120f) are obtained almost immediately by writing out the integrals and exploiting the switch trick. For Eq. $( 8 . 1 2 0 \mathrm { g } )$ we differentiate the Newtonian potential and construct the integrals that appear on the left-hand side. We have
