...
import { f as parseFontSize, h as utils_default } from "./chunk-GEFDOKGD-MA_ZFFq1.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-AywH7d0s.js";
import { t as require_dist } from "./dist-RlBhuN76.js";
import { a as drawRect, c as getTextObj, i as drawImage, n as drawBackgroundRect, r as drawEmbeddedImage, s as getNoteRect } from "./chunk-JSJVCQXG-BfYHdGkE.js";
import { t as ImperativeState } from "./chunk-QZHKN3VN-BIunecJj.js";
...
var drawActorTypeEntity = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	if (!isFooter) actElem.attr("transform", `translate(0, ${r / 2 - 5})`);
...
var drawActorTypeBoundary = /* @__PURE__ */ __name(function(elem, actor, conf2, isFooter) {
	...
	if (!isFooter) actElem.attr("transform", `translate(0,${radius / 2 + 10})`);
	else actElem.attr("transform", `translate(0,${radius / 2 + 10})`);
	return actor.height;
...
var svgDraw_default = {
	...
	insertSolidBottomArrowHead: /* @__PURE__ */ __name(function(elem) {
		elem.append("defs").append("marker").attr("id", "solidBottomArrowHead").attr("refX", 7.9).attr("refY", .75).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 12).attr("markerHeight", 12).attr("orient", "auto-start-reverse").append("path").attr("d", "M 0 0 L 10 0 L 0 8 z");
...
var drawMessage = /* @__PURE__ */ __name(async function(diagram2, msgModel, lineStartY, diagObj, msg) {
	...
	if (type === diagObj.db.LINETYPE.SOLID_TOP || type === diagObj.db.LINETYPE.SOLID_TOP_DOTTED) line.attr("marker-end", "url(" + url + "#solidTopArrowHead)");
	if (type === diagObj.db.LINETYPE.SOLID_BOTTOM || type === diagObj.db.LINETYPE.SOLID_BOTTOM_DOTTED) line.attr("marker-end", "url(" + url + "#solidBottomArrowHead)");
	if (type === diagObj.db.LINETYPE.STICK_TOP || type === diagObj.db.LINETYPE.STICK_TOP_DOTTED) line.attr("marker-end", "url(" + url + "#stickTopArrowHead)");
	if (type === diagObj.db.LINETYPE.STICK_BOTTOM || type === diagObj.db.LINETYPE.STICK_BOTTOM_DOTTED) line.attr("marker-end", "url(" + url + "#stickBottomArrowHead)");
	if (type === diagObj.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || type === diagObj.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) line.attr("marker-start", "url(" + url + "#solidBottomArrowHead)");
	if (type === diagObj.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || type === diagObj.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) line.attr("marker-start", "url(" + url + "#solidTopArrowHead)");
	if (type === diagObj.db.LINETYPE.STICK_ARROW_TOP_REVERSE || type === diagObj.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) line.attr("marker-start", "url(" + url + "#stickBottomArrowHead)");
	if (type === diagObj.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || type === diagObj.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) line.attr("marker-start", "url(" + url + "#stickTopArrowHead)");
...
var draw = /* @__PURE__ */ __name(async function(_text, id, _version, diagObj) {
	...
	for (const e of messagesToDraw) await drawMessage(diagram2, e.messageModel, e.lineStartY, diagObj, e.msg);
...
//# sourceMappingURL=sequenceDiagram-2WXFIKYE-C2tBSqt_.js.map